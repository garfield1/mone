...
WS_STATE_WAITTING_OPERATOER_COMPLETE = u"已完成"
WS_STATE_HAVE_BACK = u"已打回"
...
RA_STATE_WAITTING_DEVELOPER_CLOSED = u"待开发关闭" # 不需要
...
RA_STATE_WAITTING_TEAM_LEADER_CLOSED = u"待主管关闭" # 不需要
...
RA_STATE_WAITTING_COMPLETE = u"已完成"
...
RA_STATE_SCORES = {
	...
	RA_STATE_WAITTING_COMPLETE: 50000000L,
}
...
class ReleaseApply(models.Model):
	...
	deploy = models.CharField(max_length = 400,null = True,blank = True)
