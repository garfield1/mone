...
jQuery.fn.searchFilter.defaults = {
    ...
    /*
     * FUNCTION
     * DESCRIPTION: the function that will be called when the admin_module clicks Reset
    ...
    /*
     * FUNCTION
     * DESCRIPTION: the function that will be called when the admin_module clicks Search
     * INPUT TYPE:  JS object if stringResult is false, otherwise is JSON string
     */
    ...
    /*
     * FUNCTION
     * DESCRIPTION: the function that will be called when the admin_module clicks the Closer icon
