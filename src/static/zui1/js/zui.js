...
}(this, function init($, undefined)
{
    ...
    /**
     * merge a set of default dialog options with admin_module supplied arguments
     */
    ...
    function mergeDialogOptions(className, labels, properties, args)
    {
        ...
        // with admin_module args are still valid against the supplied labels
        return validateButtons(
            // merge the generated base properties with admin_module supplied arguments
            mergeArguments(
                baseOptions,
                args,
    ...
    exports.confirm = function()
    {
        ...
        /**
         * overrides; undo anything the admin_module tried to set they shouldn't have
         */
    ...
    exports.prompt = function()
    {
        ...
        // capture the admin_module's show value; we always set this to false before
    ...
    */
        ...
        /**
         * Standard jQuery event listeners; used to handle admin_module
        ...
        dialog.on("click", ".bootbox-close-button", function(e)
        {
            ...
            // if the admin_module has managed to click the close button we
