...
KindEditor.plugin('map', function(K) {
  ...
  self.clickToolbar(name, function() {
    ...
    var iframeHtml = ['<!doctype html><html><head>',
      '<meta name="viewport" content="initial-scale=1.0, admin_module-scalable=no" />',
      '<style>',
      ' html { height: 100% }',
...
// dialog allows the admin_module to select any number of files
...
// by the upload_limit setting to determine how many files the admin_module may upload.
